...
<section class="py-20">
    <div class="site-container">
        <div class="max-w-2xl">
            <h2 class="text-2xl md:text-3xl font-semibold mb-3">Comprometidos con un futuro mejor</h2>
            <p class="text-gray-600 text-xl">Generamos impacto social y ambiental positivo.</p>
        </div>

        <hr class="border-gray-200 my-10">

        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="p-8 md:p-10 bg-primary-400 rounded-xl shadow-lg">
